...
def main():
    ...
    parser.add_argument('private_key', type=argparse.FileType('rb'), help="Plik zawierający klucz prywatny")
    parser.add_argument('file', type=FileTypeWithExtensionCheck('rb', valid_extensions=('encrypted',)), help="Plik do odszyfrowania")
    ...
    parser.add_argument('-i', dest='info', help="Podsumowanie czasu deszyfrowania", action='store_true', required=False)
